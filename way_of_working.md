Projektplan & Way of Working
Detta dokument beskriver hur gruppen samarbetar och fördelar ansvar under projektet i kursen Edge Computing. Syftet är att använda våran kunskap inom edge computing för att bygga en IoT pipeline som streamar data från olika sensorer som vi ska kunna övervaka och observera. Vi kommer att uveckla både hårdvaran och mjukvaran.

1. Projektöversikt
Vi ska skapa en IoT-pipeline, vår plan är att utveckla ett växthussystem som övervakar och reglerar luftfuktighet och temperatur.

2. Rollfördelning (3 personer)
Vi kommer att blanda mobcoding tilsammans och dela upp olika uppgifter inom gruppen.
3. Arbetstider och Möten
Vi hör av oss på discord under dagtid och fördelar arbetet och försöker mötas upp på röst chat på eftermiddagen.
...
Alla deltar i den slutliga presentationen.
Varje medlem skriver en individuell reflektion (2 - 3 sidor).